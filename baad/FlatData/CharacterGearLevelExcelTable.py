...
class CharacterGearLevelExcelTable(object):
    ...
    @classmethod
    def GetRootAsCharacterGearLevelExcelTable(cls, buf, offset=0):
...
def CharacterGearLevelExcelTableStart(builder):
...
def CharacterGearLevelExcelTableAddDataList(builder, DataList):
...
def CharacterGearLevelExcelTableStartDataListVector(builder, numElems):
    """This method is deprecated. Please switch to Start."""
    return StartDataListVector(builder, numElems)
def End(builder): return builder.EndObject()
def CharacterGearLevelExcelTableEnd(builder):
