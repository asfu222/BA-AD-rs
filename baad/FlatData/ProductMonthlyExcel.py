...
def AddEnterCostReduceGroupId(builder, EnterCostReduceGroupId): builder.PrependInt64Slot(10, EnterCostReduceGroupId, 0)
...
def AddDailyParcelType(builder, DailyParcelType): builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(DailyParcelType), 0)
...
def AddDailyParcelId(builder, DailyParcelId): builder.PrependUOffsetTRelativeSlot(12, flatbuffers.number_types.UOffsetTFlags.py_type(DailyParcelId), 0)
...
def AddDailyParcelAmount(builder, DailyParcelAmount): builder.PrependUOffsetTRelativeSlot(13, flatbuffers.number_types.UOffsetTFlags.py_type(DailyParcelAmount), 0)
