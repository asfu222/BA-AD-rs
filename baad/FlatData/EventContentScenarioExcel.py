...
def EventContentScenarioExcelAddReplayDisplayGroup(builder, ReplayDisplayGroup):
    """This method is deprecated. Please switch to AddReplayDisplayGroup."""
    return AddReplayDisplayGroup(builder, ReplayDisplayGroup)
...
def EventContentScenarioExcelAddIsMeetup(builder, IsMeetup):
    """This method is deprecated. Please switch to AddIsMeetup."""
    return AddIsMeetup(builder, IsMeetup)
...
def EventContentScenarioExcelAddIsOmnibus(builder, IsOmnibus):
    """This method is deprecated. Please switch to AddIsOmnibus."""
    return AddIsOmnibus(builder, IsOmnibus)
...
def EventContentScenarioExcelAddConditionEventContentId(builder, ConditionEventContentId):
    """This method is deprecated. Please switch to AddConditionEventContentId."""
    return AddConditionEventContentId(builder, ConditionEventContentId)
...
def AddCostParcelType(builder, CostParcelType): builder.PrependInt32Slot(16, CostParcelType, 0)
...
def AddCostId(builder, CostId): builder.PrependInt64Slot(17, CostId, 0)
...
def AddCostAmount(builder, CostAmount): builder.PrependInt32Slot(18, CostAmount, 0)
...
def AddRewardParcelType(builder, RewardParcelType): builder.PrependUOffsetTRelativeSlot(19, flatbuffers.number_types.UOffsetTFlags.py_type(RewardParcelType), 0)
...
def AddRewardId(builder, RewardId): builder.PrependUOffsetTRelativeSlot(20, flatbuffers.number_types.UOffsetTFlags.py_type(RewardId), 0)
...
def AddRewardAmount(builder, RewardAmount): builder.PrependUOffsetTRelativeSlot(21, flatbuffers.number_types.UOffsetTFlags.py_type(RewardAmount), 0)
