...
def AttendanceExcelAddCountdownPrefab(builder, CountdownPrefab):
    """This method is deprecated. Please switch to AddCountdownPrefab."""
    return AddCountdownPrefab(builder, CountdownPrefab)
...
def AddDialogCategory_(builder, DialogCategory_): builder.PrependInt32Slot(16, DialogCategory_, 0)
