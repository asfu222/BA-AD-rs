...
def AddBgmId(builder, BgmId): builder.PrependUOffsetTRelativeSlot(20, flatbuffers.number_types.UOffsetTFlags.py_type(BgmId), 0)
...
def AddStrategyEnvironment_(builder, StrategyEnvironment_): builder.PrependInt32Slot(21, StrategyEnvironment_, 0)
...
def AddGroundId(builder, GroundId): builder.PrependInt64Slot(22, GroundId, 0)
...
def CampaignStageExcelAddStrategySkipGroundId(builder, StrategySkipGroundId):
    """This method is deprecated. Please switch to AddStrategySkipGroundId."""
    return AddStrategySkipGroundId(builder, StrategySkipGroundId)
def AddContentType_(builder, ContentType_): builder.PrependInt32Slot(24, ContentType_, 0)
...
def AddBGMId(builder, BGMId): builder.PrependInt64Slot(25, BGMId, 0)
def CampaignStageExcelAddBGMId(builder, BGMId):
    """This method is deprecated. Please switch to AddBGMId."""
    return AddBGMId(builder, BGMId)
...
def AddTacticRewardExp(builder, TacticRewardExp): builder.PrependInt64Slot(27, TacticRewardExp, 0)
...
def AddFixedEchelonId(builder, FixedEchelonId): builder.PrependInt64Slot(28, FixedEchelonId, 0)
...
def AddEchelonExtensionType_(builder, EchelonExtensionType_): builder.PrependInt32Slot(29, EchelonExtensionType_, 0)
def CampaignStageExcelAddEchelonExtensionType_(builder, EchelonExtensionType_):
