...
class CatalogParser:
    ...
    def fetch_catalogs(self) -> None:
        ...
        # progress.update(fetch_task, completed=60, description='[cyan]Fetching table data')
        ...
        # progress.update(fetch_task, completed=80, description='[cyan]Fetching media data')
